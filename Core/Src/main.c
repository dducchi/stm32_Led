...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  HAL_Delay(300);*/
	  /*htim2.Instance->CCR1 = 999; //전부 on
	  htim2.Instance->CCR2 = 0;
	  htim2.Instance->CCR3 = 0;
	  HAL_Delay(300);
	  htim2.Instance->CCR1 = 0; //전부 on
	  ...
	  int valueG = sin(angleR * 3.14 / 180)* 499 + 499;
	  int valueB = sin(angleR * 3.14 / 180)* 499 + 499;
	  htim2.Instance->CCR1 = valueR;
	  htim2.Instance->CCR2 = valueG;
	  htim2.Instance->CCR3 = valueB;
	  HAL_Delay(10);
	  //true value(one color)*/
  }
  /* USER CODE END 3 */
}
